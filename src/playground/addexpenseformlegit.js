...
testav= ()=> {
    ...
    this.state.exobject.map((expense)=>{

        if(expense.id!==this.state.id) {
          if (this.state.exbject.indexOf(this.state.description)>-1) {
...
if (this.state.haveExpense)

 {
    ...
    if (!this.state.description||!this.state.amount) {
        ...
        console.log("submitted", this.state.exobject.length, this.state.theExpense.description)}
    ...
    this.setState(()=>({error:"Please enter Amount or Description"}))
    ...
    } else { if (this.state.expensesdesc.indexOf(this.state.description)>-1) {
        ...
        console.log("submitted", this.state.description)
